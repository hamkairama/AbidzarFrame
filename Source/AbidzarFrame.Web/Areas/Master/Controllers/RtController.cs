    ...
    public class RtController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.RtResultList;
        ...
        public RtResponse GetDataList()
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Rt/GetRtList";
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Rt/GetRtFindBy";
            ...
            return PartialView("_Rt", response.RtResult);
        }

        public ActionResult Create(RtRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Rt/InsertRt";
        ...
        public ActionResult Update(RtRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Rt/UpdateRt";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.NamaRt))
                {
