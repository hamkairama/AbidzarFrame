    ...
    public class PendidikanController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.PendidikanResultList;
        ...
        public PendidikanResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Pendidikan/GetPendidikanFindBy";
            ...
            return PartialView("_Pendidikan", response.PendidikanResult);
        }

        public ActionResult Create(PendidikanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Pendidikan/InsertPendidikan";
        ...
        public ActionResult Update(PendidikanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Pendidikan/UpdatePendidikan";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.Pendidikan))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Pendidikan/DeletePendidikan";
