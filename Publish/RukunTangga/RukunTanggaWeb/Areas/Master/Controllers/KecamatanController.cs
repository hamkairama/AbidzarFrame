    ...
    public class KecamatanController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.KecamatanResultList;
        ...
        public KecamatanResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kecamatan/GetKecamatanFindBy";
            ...
            LoadData();
            return PartialView("_Kecamatan", response.KecamatanResult);
        }

        public ActionResult Create(KecamatanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kecamatan/InsertKecamatan";
        ...
        public ActionResult Update(KecamatanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kecamatan/UpdateKecamatan";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.NamaKecamatan))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kecamatan/DeleteKecamatan";
