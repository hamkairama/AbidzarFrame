...
namespace AbidzarFrame.Web.Areas.Master.Controllers
{
    public class LandingPageLevelController : WebLogManager
    {
        ...
        LandingPageLevelRequest request = new LandingPageLevelRequest();
        LandingPageLevelResponse response = new LandingPageLevelResponse();
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.LandingPageLevelResultList;
        ...
        public LandingPageLevelResponse GetDataList()
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevel/GetLandingPageLevelList";
            ...
            try
            {
                ...
                //call api
                response = JsonConvert.DeserializeObject<LandingPageLevelResponse>(JasonMapper.ConvertHttpResponseToJson(apiUrl, request));
            }
            catch (Exception ex)
            {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevel/GetLandingPageLevelFindBy";
            ...
            return PartialView("_LandingPageLevel", response.LandingPageLevelResult);
        }

        public ActionResult Create(LandingPageLevelRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevel/InsertLandingPageLevel";
        ...
        public ActionResult Update(LandingPageLevelRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevel/UpdateLandingPageLevel";
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevel/DeleteLandingPageLevel";
