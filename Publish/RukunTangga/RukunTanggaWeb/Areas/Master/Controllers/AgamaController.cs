    ...
    public class AgamaController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.AgamaResultList;
        ...
        public AgamaResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Agama/GetAgamaFindBy";
            ...
            return PartialView("_Agama", response.AgamaResult);
        }

        public ActionResult Create(AgamaRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Agama/InsertAgama";
        ...
        public ActionResult Update(AgamaRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Agama/UpdateAgama";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.NamaAgama))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Agama/DeleteAgama";
