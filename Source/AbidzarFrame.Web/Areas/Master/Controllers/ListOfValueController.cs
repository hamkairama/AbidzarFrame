...
namespace AbidzarFrame.Web.Areas.Master.Controllers
{
    public class ListOfValueController : WebLogManager
    {
        ...
        ListOfValueRequest request = new ListOfValueRequest();
        ListOfValueResponse response = new ListOfValueResponse();
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.ListOfValueResultList;
        ...
        public ListOfValueResponse GetDataList()
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/ListOfValue/GetListOfValueList";
            ...
            try
            {
                ...
                //call api
                response = JsonConvert.DeserializeObject<ListOfValueResponse>(JasonMapper.ConvertHttpResponseToJson(apiUrl, request));
            }
            catch (Exception ex)
            {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/ListOfValue/GetListOfValueFindBy";
            ...
            return PartialView("_ListOfValue", response.ListOfValueResult);
        }

        public ActionResult Create(ListOfValueRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/ListOfValue/InsertListOfValue";
        ...
        public ActionResult Update(ListOfValueRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/ListOfValue/UpdateListOfValue";
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/ListOfValue/DeleteListOfValue";
