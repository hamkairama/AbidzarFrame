    ...
    public class KewarganegaraanController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.KewarganegaraanResultList;
        ...
        public KewarganegaraanResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kewarganegaraan/GetKewarganegaraanFindBy";
            ...
            return PartialView("_Kewarganegaraan", response.KewarganegaraanResult);
        }

        public ActionResult Create(KewarganegaraanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kewarganegaraan/InsertKewarganegaraan";
        ...
        public ActionResult Update(KewarganegaraanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kewarganegaraan/UpdateKewarganegaraan";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.JenisKewarganegaraan))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kewarganegaraan/DeleteKewarganegaraan";
