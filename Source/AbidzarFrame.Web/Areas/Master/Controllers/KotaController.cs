    ...
    public class KotaController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.KotaResultList;
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kota/GetKotaFindBy";
            ...
            LoadData();
            return PartialView("_Kota", response.KotaResult);
        }

        public ActionResult Create(KotaRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kota/InsertKota";
        ...
        public ActionResult Update(KotaRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kota/UpdateKota";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.NamaKota))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Kota/DeleteKota";
