    ...
    public class JenisPekerjaanController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.JenisPekerjaanResultList;
        ...
        public JenisPekerjaanResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/JenisPekerjaan/GetJenisPekerjaanFindBy";
            ...
            return PartialView("_JenisPekerjaan", response.JenisPekerjaanResult);
        }

        public ActionResult Create(JenisPekerjaanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/JenisPekerjaan/InsertJenisPekerjaan";
        ...
        public ActionResult Update(JenisPekerjaanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/JenisPekerjaan/UpdateJenisPekerjaan";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.JenisPekerjaan))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/JenisPekerjaan/DeleteJenisPekerjaan";
