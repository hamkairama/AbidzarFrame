...
namespace AbidzarFrame.Web.Areas.Master.Controllers
{
    public class TestimoniController : WebLogManager
    {
        ...
        TestimoniRequest request = new TestimoniRequest();
        TestimoniResponse response = new TestimoniResponse();
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.TestimoniResultList;
        ...
        public TestimoniResponse GetDataList()
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Testimoni/GetTestimoniList";
            ...
            try
            {
                ...
                //call api
                response = JsonConvert.DeserializeObject<TestimoniResponse>(JasonMapper.ConvertHttpResponseToJson(apiUrl, request));
            }
            catch (Exception ex)
            {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Testimoni/GetTestimoniFindBy";
            ...
            return PartialView("_Testimoni", response.TestimoniResult);
        }

        public ActionResult Create(TestimoniRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Testimoni/InsertTestimoni";
        ...
        public ActionResult Update(TestimoniRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Testimoni/UpdateTestimoni";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.IdRw.ToString()))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Testimoni/DeleteTestimoni";
