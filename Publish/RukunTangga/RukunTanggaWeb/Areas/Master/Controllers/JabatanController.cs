    ...
    public class JabatanController : WebLogManager
    {
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.JabatanResultList;
        ...
        public JabatanResponse GetDataList()
        {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Jabatan/GetJabatanFindBy";
            ...
            return PartialView("_Jabatan", response.JabatanResult);
        }

        public ActionResult Create(JabatanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Jabatan/InsertJabatan";
        ...
        public ActionResult Update(JabatanRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Jabatan/UpdateJabatan";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.NamaJabatan))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/Jabatan/DeleteJabatan";
