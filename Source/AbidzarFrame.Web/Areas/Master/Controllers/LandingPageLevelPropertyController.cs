...
namespace AbidzarFrame.Web.Areas.Master.Controllers
{
    public class LandingPageLevelPropertyController : WebLogManager
    {
        ...
        LandingPageLevelPropertyRequest request = new LandingPageLevelPropertyRequest();
        LandingPageLevelPropertyResponse response = new LandingPageLevelPropertyResponse();
        ...
        public ActionResult Read()
        {
            try
            {
                ...
                var data = response.LandingPageLevelPropertyResultList;
        ...
        public LandingPageLevelPropertyResponse GetDataList()
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevelProperty/GetLandingPageLevelPropertyList";
            ...
            try
            {
                ...
                //call api
                response = JsonConvert.DeserializeObject<LandingPageLevelPropertyResponse>(JasonMapper.ConvertHttpResponseToJson(apiUrl, request));
            }
            catch (Exception ex)
            {
        ...
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevelProperty/GetLandingPageLevelPropertyFindBy";
            ...
            return PartialView("_LandingPageLevelProperty", response.LandingPageLevelPropertyResult);
        }

        public ActionResult Create(LandingPageLevelPropertyRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevelProperty/InsertLandingPageLevelProperty";
        ...
        public ActionResult Update(LandingPageLevelPropertyRequest model)
        {
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevelProperty/UpdateLandingPageLevelProperty";

            try
            {
                WriteFunctionLog(controller, method, 1, LogData.LOG_TYPE.begin);

                if (string.IsNullOrWhiteSpace(model.IdLandingPageLevel.ToString()))
                {
        ...
        public ActionResult Delete(int id)
        {
            ...
            string method = MethodBase.GetCurrentMethod().Name;
            string apiUrl = "api/LandingPageLevelProperty/DeleteLandingPageLevelProperty";
