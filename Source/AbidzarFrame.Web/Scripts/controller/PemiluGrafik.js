var idPemiluGrafik = $("#idPemiluGrafik").val();

var listObj = [];
var path = location.origin + "/PollingPemilu/GetDataListGrafik/";
$.ajax({
    url: path,
    type: 'Post',
    data: { idPemilu: idPemiluGrafik },
    success: function (result) {
        console.log(result);
        var obj = result.PollingPemiluResultList;
